...
x_fake01_M = pd.read_csv(r"C:\Users\hugom\OneDrive\Documentos\ETHZ academic\Project\Code\Transfusion\evaluation\sample_fake02.csv", index_col=0)
x_fake01_M = torch.Tensor(np.array(x_fake01_M)).to(device)
x_fake01_M = torch.unsqueeze(x_fake01_M, 2)
...
# powerlaw_fake01_df.to_csv(".\computations\powerlaw_fake02_df.csv")
...
# stylfeat_fake01_df.to_csv(".\computations\stylfeat_fake02_df.csv")
# stylfeat_fake01_df = pd.read_csv(".\computations\stylfeat_fake02_df.csv", index_col=0)
